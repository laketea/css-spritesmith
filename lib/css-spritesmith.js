...
var IAMGE_SIZE_CSS_TMPL = 'background-size: {imgWidth}px;';
var defaultOptions = {
    // css file
    cssfile: null,
    ...
    IAMGE_SIZE_CSS_TMPL: IAMGE_SIZE_CSS_TMPL
};
...
function cssSpriteSmith(options, callback) {
    ...
    async.waterfall([
        ...
        function processSpriteData(spriteData, cb) {
            ...
            spriteImgProperties = spriteData.properties;
        ...
        function setSlicePosition(coordinates, cb) {
            ...
            sliceData.cssList.forEach(function(cssItem) {
                ...
                css += getBgPosCss(coords.x, coords.y, options.defaultratio);
        ...
        function buildCss(cssData, cb) {
            ...
            if (options.defaultratio > 1) {
                css += '\n';
                css += fill(IAMGE_SIZE_CSS_TMPL, {
                    imgWidth: Math.max(spriteImgProperties.width / options.defaultratio, 1)
                });
            }
